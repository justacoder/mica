 ...
 */
public class MiIDeselectAll extends MiEventHandler
	{
	public				MiIDeselectAll()
		{
		addEventToCommandTranslation(Mi_EXECUTE_COMMAND_NAME, Mi_KEY_PRESS_EVENT, Mi_ESC_KEY, 0);
		}
	...
	protected	int		processCommand()
		{
		event.editor.getSelectionManager().deSelectAll();
