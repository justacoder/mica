 ...
 */
public class MiIPrint extends MiEventHandler
	{
	private		MiPrint		printCommand = new MiPrint();
	...
	public		MiPrint		getPrintCommand()
		{
		return(printCommand);
		}
	...
	protected	int		processCommand()
		{
		MiWindow root = event.editor.getRootWindow();
		root.pushMouseAppearance(MiiTypes.Mi_WAIT_CURSOR, "MiIPrint");
		printCommand.setTargetOfCommand(root);
		printCommand.processCommand(null);
		root.popMouseAppearance("MiIPrint");
