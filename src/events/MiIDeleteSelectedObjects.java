 ...
 */
public class MiIDeleteSelectedObjects extends MiEventHandler
	{
	private		MiDeletePartsCommand 	method = new MiDeletePartsCommand();

	public					MiIDeleteSelectedObjects()
		{
		addEventToCommandTranslation(Mi_EXECUTE_COMMAND_NAME, Mi_KEY_PRESS_EVENT, Mi_DELETE_KEY, 0);
		}
	...
	protected	int		processCommand()
		{
		method.setTargetOfCommand(event.editor);
		method.processCommand(MiiCommandNames.Mi_DELETE_COMMAND_NAME);
