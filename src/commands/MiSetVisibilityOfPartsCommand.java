 ...
 */
public class MiSetVisibilityOfPartsCommand extends MiCommandHandler implements MiiTransaction, MiiCommandNames, MiiDisplayNames, MiiPropertyTypes
	{
	public static final String	Mi_SET_VISIBILITY_DISPLAY_NAME	= "Set Visible";
	public static final String	Mi_SET_VISIBILITY_COMMAND_NAME	= "setVisible";
	private		boolean		visible;
	private		MiParts		parts			= new MiParts();


	public				MiSetVisibilityOfPartsCommand()
		{
		}

	protected			MiSetVisibilityOfPartsCommand(MiEditor editor, MiParts parts, boolean visible)
		{
	...
	public		void		setVisibility(MiEditor editor, MiParts parts, boolean visible)
		{
		doit(editor, parts, visible);
		MiSystem.getTransactionManager().appendTransaction(
			new MiSetVisibilityOfPartsCommand(
				editor, parts, visible));
		}
	public		void		processCommand(String arg)
		{
		throw new IllegalArgumentException(this + ": Unknown argument to processCommand: " + arg);
		}
	protected	void		doit(MiEditor editor, MiParts parts, boolean visible)
		{
	...
	public		String		getName()
		{
		return(Mi_SET_VISIBILITY_DISPLAY_NAME);
		}
					/**------------------------------------------------------
	...
	public		String		getCommand()
		{
		return(Mi_SET_VISIBILITY_COMMAND_NAME);
		}
					/**------------------------------------------------------
