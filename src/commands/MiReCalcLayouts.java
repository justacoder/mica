 ...
 *----------------------------------------------------------------------------------------------*/
public class MiReCalcLayouts extends MiCommandHandler
	{
	public				MiReCalcLayouts()
						{
						}
	...
	public		void		processCommand(String arg)
		...
		invalidateObjectContents(obj);
		obj.validateLayout();
		}

	private		void		invalidateObjectContents(MiPart object)
		{
