 ...
 *----------------------------------------------------------------------------------------------*/
public abstract class MiCommandHandler implements MiiTargetableCommandHandler
	{
	private		Object		object;

					/**------------------------------------------------------
	 				 * Constructs a new MiCommandHandler.
					 *------------------------------------------------------*/
	public				MiCommandHandler()
		{
		}
					/**------------------------------------------------------
					 ...
					 * @implements	MiiTargetableCommandHandler#setTargetOfCommand
					 *------------------------------------------------------*/
