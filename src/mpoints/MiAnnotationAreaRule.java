 ...
 */
public class MiAnnotationAreaRule implements MiiManagedPointRule, MiiTypes
	{
//	private		int		hJustification	= Mi_CENTER_JUSTIFIED;
	...
	public		MiiManagedPointRule	copy()
		{
		MiAnnotationAreaRule rule = new MiAnnotationAreaRule();
