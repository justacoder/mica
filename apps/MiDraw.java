 ...
 *----------------------------------------------------------------------------------------------*/
public class MiDraw extends Applet
	{
					/**------------------------------------------------------
	...
	public static 	void 		main(String args[])
		...
		MiSplashScreen splash = new MiSplashScreen(
			new MiImage(MiSystem.getProperty(MiSystem.Mi_HOME) + "/apps/MiDrawSplash.gif"));
	...
	public		void		init()
		...
		MiUtility.getFrame(this).add("Center", (Component )window.getCanvas().getNativeComponent());
		window.setCapabilities(
					false,		// hasGraphsMenu
					true,		// hasLayoutsMenu
					true,		// hasDrawingToolbar
	...
	protected static void		loadSpecifiedGraphicsAndPalette(
		...
		if ((filename != null) || (palette != null))
			...
			try	{
				...
				e.printStackTrace();
				System.out.println(
					"Usage: MiDraw [-file <filename>] [-title <window title>] [-palette <palette name>");
				System.exit(1);
				}
			}
		}
